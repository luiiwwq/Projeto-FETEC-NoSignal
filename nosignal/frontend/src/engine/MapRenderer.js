...
export class MapRenderer {
    ...
    loadMapSurfaceTexture() {
        ...
        img.onerror = () => {
            ...
            fallback.src = './src/assets/sprites/Map/map_surface2.jpeg';
        };
    ...
    _duneTone(wx, wy) {
        ...
        if (f < 0.5) {
            const t = f * 2;
            return mixHex(P.groundRed, P.groundOrange, t);
        }
        const t = (f - 0.5) * 2;
        return mixHex(P.groundOrange, P.groundDark, t);
    }
    ...
    _surfaceGroundStyle(wx, wy) {
        ...
        else base = this._duneTone(wx, wy);
        return { base };
    }
